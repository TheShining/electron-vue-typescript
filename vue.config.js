...
module.exports = {
    ...
    chainWebpack: (config) => {
        ...
        config.resolve.alias
            ...
            .set('utils', resolve('src/renderer/utils'))
    ...
    css: {
        loaderOptions: {
            ...
            sass: {
                prependData: `
                @import "@/renderer/common/styles/common.scss";
                @import "@/renderer/common/styles/mixin.scss";
                @import "@/renderer/common/styles/reset.scss";  
                `,
            },
        },
    },
